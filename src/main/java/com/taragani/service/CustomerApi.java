...
public class CustomerApi {
	...
	public ResponseEntity<Customer> getAllPlans (
		...
		@PathVariable("srchValue") String searchValue)
	{
		ResponseEntity<Customer> resp;
			switch(fieldBy){
			case "name":
				Customer pbs= customerService.getCustomerByName(searchValue);
				if(pbs!=null){
			...
			case "mbno":				
				Customer pbu= customerService.getCustomerMyMbno(searchValue);
				if(pbu!=null){
	...
	@GetMapping("/{cid}")
	public ResponseEntity<Customer> getCustomerByNameAction(@PathVariable("cid") int cid) {
